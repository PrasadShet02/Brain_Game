...
b26=Button(root,text="",padx=20,pady=20,bg="white",command=click26)
b26.grid(row=4,column=1)
b27=Button(root,text="",padx=20,pady=20,bg="white",command=click27)
b27.grid(row=4,column=2)
b28=Button(root,text="",padx=20,pady=20,bg="white",command=click28)
b28.grid(row=4,column=3)
b29=Button(root,text="",padx=20,pady=20,bg="white",command=click29)
b29.grid(row=4,column=4)
b30=Button(root,text="",padx=20,pady=20,bg="white",command=click30)
b30.grid(row=4,column=5)
b31=Button(root,text="",padx=20,pady=20,bg="white",command=click31)
b31.grid(row=5,column=0)
b32=Button(root,text="",padx=20,pady=20,bg="white",command=click32)
b32.grid(row=5,column=1)
b33=Button(root,text="",padx=20,pady=20,bg="white",command=click33)
b33.grid(row=5,column=2)
b34=Button(root,text="",padx=20,pady=20,bg="white",command=click34)
b34.grid(row=5,column=3)
b35=Button(root,text="",padx=20,pady=20,bg="white",command=click35)
b35.grid(row=5,column=4)
b36=Button(root,text="",padx=20,pady=20,bg="white",command=click36)
b36.grid(row=5,column=5)
    
butset=set([b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15,b16,b17,b18,b19,b20,b21,b22,b23,b24,b25,b26,b27,b28,b29,b30,b31,b32,b33,b34,b35,b36])

def colorswitch(x):
        x.config(bg='grey')
        x.after(2000,lambda: x.config(bg='white'))
        
y=set(random.sample(butset,15))
for i in y:
    colorswitch(i)
...
def ad(r):
    if r in y:
        w.add(r)
        if len(w)==15:
            mb.showinfo("Visual memory","Well done! You beat the game!")
            root.destroy()
            exit()
...
def checking(s):
    if s in y:
        ...
        l2.grid(row=6,column=2)
        mb.showinfo("Visual memory","Oops, thanks for playing! You cleared 11 levels!")
        root.destroy()
        exit()
